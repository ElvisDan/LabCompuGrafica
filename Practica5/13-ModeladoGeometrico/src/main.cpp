...
void applicationLoop() {
	...
	while (psi) {
		...
		//Matriz de vista
		glm::mat4 view = glm::translate(glm::mat4(1.0f), glm::vec3(0.0f, 0.0f, -8.0f));//cambiar esto para la practica
		...
		matrix0 = glm::scale(matrix0, glm::vec3(0.6f, 1.0f, 0.6f));//Escaliemnto del cilindro
