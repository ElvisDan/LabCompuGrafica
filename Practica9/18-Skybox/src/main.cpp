...
Sphere sphere(20, 20), sphere2(20, 20);
Cylinder cylinder(20, 20, 0.5, 0.5), cylinder2(20, 20, 0.5, 0.5);
Box box;
...
std::string fileNames[6] = { 
	"../../Textures/hw_nightsky/nightsky_ft.tga",
...
void applicationLoop() {
	...
	while (psi) {
		...
		cylinder2.setPosition(glm::vec3(0.1, 0.1, 0.1));
		...
		//glUniform3fv(shaderSpotLight.getUniformLocation("light.position"), 1, glm::value_ptr(glm::vec3(2.0, 0.0, 5.0)));
		...
		glUniform1f(shaderSpotLight.getUniformLocation("light.cutOff"), glm::cos(glm::radians(15.0f)));//Cambian el valor de apertura del radio
		glUniform1f(shaderSpotLight.getUniformLocation("light.outerCutOff"), glm::cos(glm::radians(17.0f)));//Cambia el valor del radio
		glUniform1f(shaderSpotLight.getUniformLocation("light.constant"), 1.0f);
		glUniform1f(shaderSpotLight.getUniformLocation("light.linear"), 0.22f);
		glUniform1f(shaderSpotLight.getUniformLocation("light.quadratics"), 0.20f);
		glUniform1f(shaderSpotLight.getUniformLocation("material.shininess"), 32.0);
		sphere2.render();
		sphere2.setPosition(glm::vec3(0.0, 0.0, -20.0));
		sphere2.render();
		cylinder2.setPosition(glm::vec3(0.0, 0.0, -10.0));
		cylinder2.render();
		...
		// Se Dibuja el Skybox
		GLint oldCullFaceMode; //Se renderiza el skybox
