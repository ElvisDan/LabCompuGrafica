...
void init(int width, int height, std::string strTitle, bool bFullScreen) {
	...
	// Texture Goku
	texture = Texture("../../Textures/PuertaPrincipal.jpg");
...
void applicationLoop() {
	...
	while (psi) {
		...
		box.setScale(glm::vec3(60.0, 30.0, 1.5));
		box.render();
		...
		box.setProjectionMatrix(projection);
		box.setViewMatrix(view);
		box.setPosition(glm::vec3(15.0, -10.0, 25.0));
		box.setScale(glm::vec3(15.0, 15.0, 1.8));
		box.render();

		//Ventana frontal  (lado izquierdo)
		glBindTexture(GL_TEXTURE_2D, textureID25);
		box.setShader(&shaderPointLight);
		box.setProjectionMatrix(projection);
		box.setViewMatrix(view);
		box.setPosition(glm::vec3(-6.0, 8.0, 25.0));
		box.setScale(glm::vec3(10.0, 10.0, 1.8));
		box.render();

		//Ventana frontal  (lado derecho)
		glBindTexture(GL_TEXTURE_2D, textureID25);
		box.setShader(&shaderPointLight);
		box.setProjectionMatrix(projection);
		box.setViewMatrix(view);
		box.setPosition(glm::vec3(36.0, 8.0, 25.0));
		box.setScale(glm::vec3(10.0, 10.0, 1.8));
		box.render();
		//pared lateral 1 (lado izquierdo)
		glBindTexture(GL_TEXTURE_2D, textureID4);
		box2.setShader(&shaderPointLight);
		box2.setProjectionMatrix(projection);
		box2.setViewMatrix(view);
		box2.setPosition(glm::vec3(-15.0, 0.0, 11.0));
		box2.setScale(glm::vec3(2.0, 30.0, 29.0));
		box2.render();

		//Ventana lateral 1 (lado izquierdo)
		glBindTexture(GL_TEXTURE_2D, textureID25);
		box.setShader(&shaderPointLight);
		box.setProjectionMatrix(projection);
		box.setViewMatrix(view);
		box.setPosition(glm::vec3(-15.0, 9.0, 11.0));
		box.setScale(glm::vec3(2.3, 8.0, 15.0));
		box.render();

		//pared lateral 2 (lado derecho)
		glBindTexture(GL_TEXTURE_2D, textureID4);
		box3.setShader(&shaderPointLight);
		box3.setProjectionMatrix(projection);
		box3.setViewMatrix(view);
		box3.setPosition(glm::vec3(45.0, 0.0, 11.0));
		box3.setScale(glm::vec3(2.0, 30.0, 29.0));
		box3.render();

		//Ventana lateral 2 (lado derecho)
		glBindTexture(GL_TEXTURE_2D, textureID25);
		box.setShader(&shaderPointLight);
		box.setProjectionMatrix(projection);
		box.setViewMatrix(view);
		box.setPosition(glm::vec3(45.0, 9.0, 11.0));
		box.setScale(glm::vec3(2.3, 8.0, 15.0));
		box.render();
		...
		box1.setPosition(glm::vec3(15.0, -16.0, 15.0));
		box1.setScale(glm::vec3(60.0, 2.0, 59.0));
		box1.render();
		...
		box1.setProjectionMatrix(projection);
		box1.setViewMatrix(view);
		box1.setPosition(glm::vec3(15.0, -18.0, 15.0));
		box1.setScale(glm::vec3(100.0, 0.0, 100.0));
		box1.render();
		...
		box1.setProjectionMatrix(projection);
		box1.setViewMatrix(view);
		box1.setPosition(glm::vec3(15.0, 15.0, 15.0));
		box1.setScale(glm::vec3(80.0, 2.0, 50.0));
		box1.render();
		...
		box1.setProjectionMatrix(projection);
		box1.setViewMatrix(view);
		box1.setPosition(glm::vec3(10.0, 0.0, 11.0));
		box1.setScale(glm::vec3(50.0, 2.0, 28.0));
		box1.render();
		...
		box2.setProjectionMatrix(projection);
		box2.setViewMatrix(view);
		box2.setPosition(glm::vec3(5.0, 7.0, 11.0));
		box2.setScale(glm::vec3(2.0, 15.0, 28.0));
		box2.render();
		...
		box2.setScale(glm::vec3(2.5, 12.0, 5.0));
		box2.render();
		...
		box2.setProjectionMatrix(projection);
		box2.setViewMatrix(view);
		box2.setPosition(glm::vec3(5.5, 13.0, 15.0));
		...
		box2.setProjectionMatrix(projection);
		box2.setViewMatrix(view);
		box2.setPosition(glm::vec3(13.0, 8.0, 10.0));
		box2.setScale(glm::vec3(15.0, 15.0, 0.1));
		box2.render();
		...
		box2.setProjectionMatrix(projection);
		box2.setViewMatrix(view);
		box2.setPosition(glm::vec3(20.0, 8.0, 2.0));
		box2.setScale(glm::vec3(0.5, 15.0, 10.0));
		box2.render();
		...
		box2.setProjectionMatrix(projection);
		box2.setViewMatrix(view);
		box2.setPosition(glm::vec3(43.0, -15.0, 20.0));
		...
		box2.setProjectionMatrix(projection);
		box2.setViewMatrix(view);
		box2.setPosition(glm::vec3(41.0, -14.0, 20.0));
		box2.setScale(glm::vec3(3.0, 2.0, 5.0));
		box2.render();
		...
		box2.setProjectionMatrix(projection);
		box2.setViewMatrix(view);
		box2.setPosition(glm::vec3(40.0, -12.0, 20.0));
		box2.setScale(glm::vec3(3.0, 2.0, 5.0));
		box2.render();//escalon
		glBindTexture(GL_TEXTURE_2D, textureID4);
		box2.setShader(&shaderPointLight);
		box2.setProjectionMatrix(projection);
		box2.setViewMatrix(view);
		box2.setPosition(glm::vec3(39.0, -11.0, 20.0));
		box2.setScale(glm::vec3(3.0, 2.0, 5.0));
		box2.render();
		...
		box2.setProjectionMatrix(projection);
		box2.setViewMatrix(view);
		box2.setPosition(glm::vec3(38.0, -10.0, 20.0));
		box2.setScale(glm::vec3(3.0, 2.0, 5.0));
		box2.render();
		...
		box2.setProjectionMatrix(projection);
		box2.setViewMatrix(view);
		box2.setPosition(glm::vec3(37.0, -9.0, 20.0));
		box2.setScale(glm::vec3(3.0, 2.0, 5.0));
		box2.render();
		//escalon
		glBindTexture(GL_TEXTURE_2D, textureID4);
		...
		box2.setProjectionMatrix(projection);
		box2.setViewMatrix(view);
		box2.setPosition(glm::vec3(36.0, -8.0, 20.0));
		box2.setScale(glm::vec3(3.0, 2.0, 5.0));
		box2.render();
		//escalon
		glBindTexture(GL_TEXTURE_2D, textureID4);
		...
		box2.setProjectionMatrix(projection);
		box2.setViewMatrix(view);
		box2.setPosition(glm::vec3(35.0, -7.0, 20.0));
		box2.setScale(glm::vec3(3.0, 2.0, 5.0));
		box2.render();
		//escalon
		glBindTexture(GL_TEXTURE_2D, textureID4);
		...
		box2.setProjectionMatrix(projection);
		box2.setViewMatrix(view);
		box2.setPosition(glm::vec3(34.0, -6.0, 20.0));
		box2.setScale(glm::vec3(3.0, 2.0, 5.0));
		box2.render();
		...
		box2.setProjectionMatrix(projection);
		box2.setViewMatrix(view);
		box2.setPosition(glm::vec3(33.0, -5.0, 20.0));
		box2.setScale(glm::vec3(3.0, 2.0, 5.0));
		box2.render();
		//escalon
		glBindTexture(GL_TEXTURE_2D, textureID4);
		...
		box2.setProjectionMatrix(projection);
		box2.setViewMatrix(view);
		box2.setPosition(glm::vec3(32.0, -4.0, 20.0));
		box2.setScale(glm::vec3(3.0, 2.0, 5.0));
		box2.render();
		//escalon
		glBindTexture(GL_TEXTURE_2D, textureID4);
		...
		box2.setProjectionMatrix(projection);
		box2.setViewMatrix(view);
		box2.setPosition(glm::vec3(31.0, -3.0, 20.0));
		box2.setScale(glm::vec3(3.0, 2.0, 5.0));
		box2.render();
		//escalon
		glBindTexture(GL_TEXTURE_2D, textureID4);
		...
		box2.setProjectionMatrix(projection);
		box2.setViewMatrix(view);
		box2.setPosition(glm::vec3(30.0, -2.0, 20.0));
		box2.setScale(glm::vec3(3.0, 2.0, 5.0));
		box2.render();
		...
		box2.setProjectionMatrix(projection);
		box2.setViewMatrix(view);
		box2.setPosition(glm::vec3(10.0, -8.0, 6.0));
		box2.setScale(glm::vec3(2.0, 15.0, 18.0));
		box2.render();
		...
		box2.setProjectionMatrix(projection);
		box2.setViewMatrix(view);
		box2.setPosition(glm::vec3(25.0, -8.0, 6.0));
		box2.setScale(glm::vec3(2.0, 15.0, 18.0));
		box2.render();
